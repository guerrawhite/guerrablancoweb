    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 gap-16 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <div className="text-center w-full">
          ...
          <p className="mt-2 max-w-96 text-center text-sm font-[family-name:var(--font-geist-mono)]">Programador en constante evolución 🚀. 8 años de experiencia en desarrollo 
        ...
        <code className="relative border-t-12 border-solid border-white max-w-55 block text-center p-3 mx-auto rounded bg-[#420042] text-[#09FF00] text-sm">
            Java, JSP, Spring, JQuery, Javascript, MySQL, Git, HTML, CSS, React, Next.js, Node.js
            <span className="block p-1 bg-[#ff0000] w-1 h-1 rounded-full absolute -top-2.5 left-1.5"></span>
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <Link className="rounded-full border border-solid border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#1a1a1a] hover:border-transparent text-lm h-12 px-5 min-w-44"
            href="mailto:cguerrav5@gmail.com">
            Contacto
          </Link>
          <Link className="rounded-full border border-solid border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#1a1a1a] hover:border-transparent text-lm h-12 px-5 min-w-44"
            href="/proyectos">
